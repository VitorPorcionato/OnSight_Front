                        ...
                        { serviceCalls && serviceCalls.length > 0
                            ? serviceCalls.map((call) => (
                                <button
                                    ...
                                    className="bg-[#FAFAFA] hover:bg-[#f6f6f6] active:bg-[#f0f0f0] w-[100%] rounded-xl h-[68px] shadow-md px-5 transition-transform scale-100 hover:scale-[1.02]"
                                    onClick={() => handleCardSelection(call)}
                                >
                                    <div className="flex items-center justify-between">
                                        <div className='flex items-center gap-5'>
                                            <Avatar>
                                                <AvatarImage className="w-[100%]" src={call.clientPhotoImageUrl} />
                                            </Avatar>
                                            <div className="flex flex-col text-start">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="w-[6px] h-[6px] rounded-full bg-[#142937]"></span>
